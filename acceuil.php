...
<div class="container">
    ...
    <div class="menu">
        <a href="http://localhost:63342/GHADI_Taha/register.php" class="btn">🔹 Inscription Étudiant</a>
        <a href="http://localhost:63342/GHADI_Taha/login.php" class="btn">🔹 Connexion Étudiant</a>
        <a href="http://localhost:63342/GHADI_Taha/admin_dashboard.php" class="btn">🔹 Connexion Administrateur</a>
        <a href="http://localhost:63342/GHADI_Taha/scanner.php" class="btn">🔹 Marquer ma présence</a>
    </div>
